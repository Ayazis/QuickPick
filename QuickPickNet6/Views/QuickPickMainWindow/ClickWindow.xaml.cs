...
public partial class ClickWindow : Window
{
	...
	/// <summary>
	/// Eventhandler not being called by xaml, but from main program.
	/// </summary>
	/// <param name="sender"></param>
	/// <param name="e"></param>
	public void HandleLeftMouseClick(object sender, EventArgs e)
	{
	...
	{		
		// todo: Get visible dimensions instead.
